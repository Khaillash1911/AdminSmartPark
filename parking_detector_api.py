...
PLATE_DIR       = BASE_DIR / "plate_detector"
PARKING_JSON    = BASE_DIR / "bounding_box" / "parking_points.json"
SAMPLE_IMAGES   = PLATE_DIR / "sample_images"
ANNOTATED_DIR   = PLATE_DIR / "annotated_images"

# Add plate_detector to python path so we import its modules
...
def _detection_generator():
    ...
    try:
        ...
        model_path = PLATE_DIR / "yolov8n.pt"
